        ...
        do {
            ...
            if (op == 1) {
                do {
                    ...
                    System.out.println("Ingrese pasaporte del propietario:");
                    ...
                    switch (op2) {
                        case 1:
                            ...
                            PlanPostPagoMinutos pppm = new PlanPostPagoMinutos(minutosNacionales, costoMinutoNacional,
                                    minutosInternacionales, costoMinutoInternacional, nombre, apellido, pasaporte, ciudad, barrio, marca, modelo,
                                    numeroCelular);
